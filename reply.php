...
<body>
    ...
    while($row=$query3->fetch_assoc()){
        $postpeople = $row['username'];
        $ckeditors =  $row['ckeditor'];
    }
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        $reply = $_POST['reply-post'];
        $sql = "INSERT INTO reply (replytext, postid) VALUES ('$reply', '$postid')";
    ...
    <div class="ckeditor" id="ckeditor">
        ...
        <div class="card">
            <div class="card-header bg-danger"style="color:white;">
                Creating Reply to <?php echo $postpeople ?>
            </div>
            <div class="before-reply">
                  <?php
                    echo $ckeditors;
                    ?>  
            </div>
            <div class="card-body">
                <form action="#" method="POST" name="postform" enctype="multipart/form-data">
                    <table width="100%">
                        <tr>
                            <td><textarea class="ckeditor" id="ckeditor" name="reply-post"></textarea></td>
                        </tr>
                        <tr>
                            <td> </td>
                        </tr>
                        <tr>
                            <div class="submit-reply">
                                <td><input type="submit" name="submitreply" value="Reply" style="margin-top : 20px;margin-bottom : 20px;background-color: black; color:white; padding:6px 10px; border-radius:5px; text-decoration:none; border:none;" /></td>
                            </div>
                        </tr>
                    </table>
                </form>
                <a href=""><i class="fa fa-reply" aria-hidden="true" style="margin: 10px 10px;"></i></a>
